...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Получить постоянную ссылку для приглашения учеников' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Создать приглашение для ученика (ссылка для регистрации)' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'from', required: true, description: 'Начало периода (ISO date)', example: '2025-01-01' }),
    (0, swagger_1.ApiQuery)({ name: 'to', required: true, description: 'Конец периода (ISO date)', example: '2025-12-31' }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'applyToSeries', required: false, enum: ['this', 'future', 'all'] }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('lessonId')),
    __param(2, (0, common_1.Body)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Получить краткую статистику ученика (для карточки)' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('studentId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
