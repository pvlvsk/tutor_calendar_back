...
let ParentService = class ParentService {
    constructor(parentProfileRepo, relationRepo, linkRepo, lessonRepo, lessonStudentRepo, studentProfileRepo, teacherProfileRepo, subjectRepo, statsService, debtService) {
...
exports.ParentService = ParentService = __decorate([
    ...
    __param(4, (0, typeorm_1.InjectRepository)(entities_1.LessonStudent)),
    __param(5, (0, typeorm_1.InjectRepository)(entities_1.StudentProfile)),
    __param(6, (0, typeorm_1.InjectRepository)(entities_1.TeacherProfile)),
    __param(7, (0, typeorm_1.InjectRepository)(entities_1.Subject)),
